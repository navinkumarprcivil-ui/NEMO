 ...
 * The server-side half of the switch in app.jsx. Razorpay does not onboard merchants that
 * sell live animals, so while this is false the /p/ product pages, the /p/ catalogue index
 * and the sitemap are rendered from a catalogue with the Live Fish category filtered out.
 *
 ...
 *
 * This MUST be flipped together with LIVE_FISH_ENABLED in app.jsx.
 * test/live-fish-switch.test.mjs fails the build if the two ever disagree.
 * See docs/LIVE_FISH_BACKOUT.md. */
export const LIVE_FISH_ENABLED = false;
